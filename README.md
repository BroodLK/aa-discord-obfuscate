# Discord Obfuscate Plugin for Alliance Auth<a name="discord-obfuscate-plugin-for-alliance-auth"></a>

This is a Discord Obfuscate plugin app for [Alliance Auth](https://gitlab.com/allianceauth/allianceauth)
(AA).
...
Kalkoken was so friendly to provide it Â» [Alliance Auth Discord Obfuscate App (GitLab Version)](https://gitlab.com/ErikKalkoken/allianceauth-discord-obfuscate)

______________________________________________________________________

<!-- mdformat-toc start --slug=github --maxlevel=6 --minlevel=1 -->

- [Discord Obfuscate Plugin for Alliance Auth](#discord-obfuscate-plugin-for-alliance-auth)
  - [Features](#features)
...
To use this app as a basis for your own development, just fork this repo and then
...
```bash
git clone https://github.com/YourName/aa-discord-obfuscate.git aa-your-app-name
cd aa-your-app-name
rm -rf .git
git init
pre-commit install
...
additional apps that might also be called Discord Obfuscate.

Here is an overview of the places that you need to edit to adopt the name.

Easiest is to just find & replace `discord_obfuscate` with your new app name in all files
listed below.
...
| ---------------------------------------- | -------------------------------------------------------------------------------------- |
| `./discord_obfuscate/`                             | Folder name                                                                            |
| `./discord_obfuscate/static/discord_obfuscate/`              | Folder name                                                                            |
| `./discord_obfuscate/templates/discord_obfuscate/`           | Folder name                                                                            |
| `./pyproject.cfg`                        | Update module name for version import, update package name, update title, author, etc. |
| `./discord_obfuscate/apps.py`                      | App name                                                                               |
| `./discord_obfuscate/__init__.py`                  | App name                                                                               |
| `./discord_obfuscate/auth_hooks.py`                | Menu hook config incl. icon and label of your app's menu item appearing in the sidebar |
| `./discord_obfuscate/models.py`                    | App name                                                                               |
| `./discord_obfuscate/urls.py`                      | App name                                                                               |
| `./discord_obfuscate/views.py`                     | Permission name and template path                                                      |
| `./discord_obfuscate/templates/discord_obfuscate/base.html`  | Title of your app to be shown in all views and as title in the browser tab             |
| `./discord_obfuscate/templates/discord_obfuscate/index.html` | Template path                                                                          |
